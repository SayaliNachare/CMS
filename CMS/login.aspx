      ...
      <form class="login-form" runat="server">
        ...
        <div class="row margin">
          <div class="input-field col s12">
            ...
            <asp:TextBox ID="txtpass" TextMode="Password" runat="server" ></asp:TextBox> 
                    ...
                    ControlToValidate="txtpass" ErrorMessage="Missing Field"></asp:RequiredFieldValidator>
        ...
        <div class="row">
          <div class="btn waves-effect waves-light col s12">
              <asp:Button ID="btnlogin" runat="server" OnClick="btnlogin_Click"  Text="Login" BackColor="#0099CC" BorderStyle="None" Width="437px" Height="28px" ></asp:Button>
          </div>
        </div>
        <div class="row">
          ...
          <div class="input-field col s6 m6 l6">
              <p class="margin right-align medium-small"><a href="forgot-password.aspx">Forgot password?</a></p>
          </div>          
        </div>
